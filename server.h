...
#define BAD_SERVER_STATE "\nLooks like the server is in a really bad state for this request. Error 500, Internal server error will be sent.\n"

#define MISORDERED_PRIMARY "\nClient sent request in an improper state.\n"

#define UNEXPECTED "\nA requested has been processed that passed quality check, but appears invalid. A response code of 400 will be sent.\n"
...
void bad_format_2(char* error_message, int error_code, int is_fatal, Info* info);
